...
const TableauBord = {
  ...
  afficher(d) {
    ...
    const carte = (titre, valeur, detail, classe = '') => creer('div', { classe: 'carte-indicateur ' + classe }, [
    ...
    zone.append(creer('div', { classe: 'grille-indicateurs' }, [
    ...
    const panneaux = creer('div', { classe: 'deux-colonnes tableau-bord-panneaux' });
    const ventes = creer('div', { classe: 'panneau' }, [creer('h3', { texte: 'Ventes par mode' })]);
    ...
    const stock = creer('div', { classe: 'panneau' }, [creer('h3', { texte: 'Articles a surveiller' })]);
    ...
    const top = creer('div', { classe: 'panneau' }, [creer('h3', { texte: 'Meilleures sorties du jour' })]);
